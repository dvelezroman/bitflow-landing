...
export function LandingContact() {
  ...
  return (
    <section
      id="contacto"
      className="scroll-mt-24 pt-16 sm:pt-20 md:scroll-mt-28 md:pt-28 pb-[max(4.5rem,calc(2.5rem+env(safe-area-inset-bottom,0px)))] sm:pb-20 md:pb-28"
    >
      <div className="section-inner">
        <h2 className="section-title">{t('contact.title')}</h2>
        <p className="section-lead">{t('contact.subtitle')}</p>

        <div className="mt-10 grid gap-12 sm:mt-12 lg:grid-cols-5 lg:gap-16">
          ...
          <div className="lg:col-span-2">
            <div className="border-t border-slate-200 pt-6 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0">
              ...
              <ul className="mt-6 space-y-5">
                <li>
                  ...
                  <a
                    ...
                    className="mt-1 block text-base font-medium text-teal-700 transition hover:text-teal-800"
                  >
                    {SITE.email}
                  </a>
                </li>
                <li>
                  <p className="text-xs text-slate-500">{t('contact.phoneLabel')}</p>
                  <a
                    href={`tel:+${SITE.phoneE164Digits}`}
              ...
              <a
                ...
                className="btn-secondary mt-8 w-full gap-2"
              >
